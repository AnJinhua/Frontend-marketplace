        ...
        <div className='row'>
          <div className='col-lg-12'>
            ...
            <table className="table de-table table-rank">
              <thead>
                <tr style={{ color: "#000000", fontSize: 18, textAlign: "center" }}>
                  <th scope="col" style={{ paddingLeft: 50, textAlign: "left" }}>Collection</th>
              ...
              <tbody>
                {
                  authors && authors.map((author, index) => (
                    <tr key={index}>
                      <th scope="row" style={{ color: "#27a8c6" }}>
                      ...
                      <td style={{ color: "#27a8c6"}}>{ author.author_sale && author.author_sale.volume }</td>
                      <td className={author.author_sale && author.author_sale.daily_sales < 0 ? "d-min" : "d-plus"}>{`${author.author_sale && author.author_sale.daily_sales < 0 ? '' : '+'}${author.author_sale && author.author_sale.daily_sales}%`}</td>
                      <td className={author.author_sale && author.author_sale.weekly_sales < 0 ? "d-min" : "d-plus"}>{`${author.author_sale && author.author_sale.weekly_sales < 0 ? '' : '+'}${author.author_sale && author.author_sale.weekly_sales}%`}</td>
                      <td style={{ color: "#27a8c6" }}>{author.author_sale && author.author_sale.floor_price}</td>
                      <td>{author.author_sale && author.author_sale.owners}k</td>
                      <td>{author.author_sale && author.author_sale.assets}k</td>
                    </tr>
                  ))
                }
              </tbody>
