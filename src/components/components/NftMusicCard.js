            ...
            <div className="nft__item m-0">
                ...
                <div className="author_list_pp">
                    <span onClick={()=> navigateTo(nft.author_link)}>                                    
                        <img className="lazy" src={nft.author !== null ? (api.baseUrl + nft.author.avatar.url) : (api.baseUrl + "/uploads/author_default.jpg")} alt="" style={{width: '50px', height: '50px', objectFit: 'cover'}}/>
