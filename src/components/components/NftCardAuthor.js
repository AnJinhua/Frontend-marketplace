...
const NftCardAuthor = ({ nft, className = 'd-item col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-4', clockTop = true, height, onImgLoad }) => {
            ...
            <div className="nft__item m-0">            
             <div className='icontype'><i className="fa fa-bookmark"></i></div>                
                ...
                <div className="author_list_pp">
                    <span className={nft.author_link} onClick={()=> navigateTo(nft.author_link)}>                                    
                        <img className="lazy" src={nft.author !== null ? (api.baseUrl + nft.author.avatar.url) : (api.baseUrl + "/uploads/author_default.jpg")} alt=""/>                        
