...
const CustomCollection = ({ index, avatar, banner, username, description, collectionId }) => {
  return (
    <div className='itm' index={index}>
      <div className="nft_coll">
          <div className="nft_wrap">
              <span><img src={banner} className="lazy img-fluid" alt="" style={{ maxWidth: "98%" }} /></span>
          </div>
...
export default memo(CustomCollection);